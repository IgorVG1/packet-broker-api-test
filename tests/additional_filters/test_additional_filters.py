...
from clients.additional_filters.additional_filters_client import get_additional_filters_client
...
def create_additional_filters():
    ...
    additional_filters_client = get_additional_filters_client(user=authentication_user)
    ...
    create_additional_filters_response = additional_filters_client.create_additional_filters_api(request=create_additional_filters_request)
...
def update_additional_filters():
    ...
    update_additional_filters_response = additional_filters_client.update_additional_filters_api(request=update_additional_filters_request)
